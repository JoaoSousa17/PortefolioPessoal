            ...
            {loading ? (
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                {posts.map((post, index) => (
                  <Card 
                    key={post.id}
                    className="group bg-white border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-in fade-in slide-in-from-bottom"
                    style={{ animationDelay: `${index * 80}ms` }}
                  >
                    {/* Hover accent line */}
                    <div className="h-2 bg-gradient-to-r from-red-700 to-red-800 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
                    ...
                    <CardHeader className="p-8 md:p-10">
                      ...
                      {/* Excerpt */}
                      {post.excerpt && (
                        <CardDescription className="text-lg text-slate-600 leading-relaxed line-clamp-3">
                          {post.excerpt}
                        </CardDescription>
                      )}
                    </CardHeader>
