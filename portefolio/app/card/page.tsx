...
export default function LinktreePage() {
  ...
  const websites = profile ? [
    {
      name: getTranslated(profile, 'website1_name', language),
      url: profile.website1_url,
      image: profile.website1_image,
      color: 'bg-gradient-to-br from-purple-500 to-pink-500'
    },
    {
      name: getTranslated(profile, 'website2_name', language),
      url: profile.website2_url,
      image: profile.website2_image,
      color: 'bg-gradient-to-br from-blue-500 to-cyan-500'
    },
    {
      name: getTranslated(profile, 'website3_name', language),
  ...
  const bioLong  = getTranslated(profile, 'bio_long', language)
  const headline = getTranslated(profile, 'headline', language)
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 flex items-center gap-2 bg-white/90 backdrop-blur-md border border-slate-200 shadow-lg rounded-full px-3 py-2 text-sm font-semibold text-slate-700 hover:scale-105 hover:shadow-xl transition-all duration-300"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <div className="pt-20 pb-8 px-8">
            ...
            {/* Bio */}
            {bioLong && (
              <p className="text-slate-700 text-center leading-relaxed mb-1 text-sm animate-in fade-in slide-in-from-bottom duration-700 whitespace-pre-line"
            ...
            {/* Headline */}
            {headline && (
              <p className="text-slate-700 text-center leading-relaxed mb-6 text-sm font-medium animate-in fade-in slide-in-from-bottom duration-700 whitespace-pre-line"
            ...
            <div className="flex justify-center mb-8 animate-in fade-in slide-in-from-bottom duration-700"
              ...
              <Button
                asChild
                className="px-8 py-3 rounded-full w-full font-bold text-white bg-gradient-to-r from-red-600 to-red-700 transition-all duration-300 ease-out hover:brightness-110 hover:saturate-110 hover:ring-2 hover:ring-red-500/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
              >
            ...
            <div className="relative my-8 animate-in fade-in slide-in-from-left duration-700"
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-slate-700 uppercase tracking-widest">Links</span>
                  <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" style={{ animationDelay: '0.5s' }} />
                </div>
              </div>
            </div>
            ...
            {websites.length > 0 && (
              <div className="relative my-8 animate-in fade-in slide-in-from-right duration-700"
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
                    <span className="text-xs font-bold text-slate-700 uppercase tracking-widest">Websites</span>
                    <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" style={{ animationDelay: '0.5s' }} />
                  </div>
                </div>
              </div>
            ...
            {websites.length > 0 && (
              <div className="space-y-4">
                {websites.map((website, index) => (
                  ...
                  >
                    <div className="relative h-32 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.03] hover:-translate-y-1 cursor-pointer ring-2 ring-transparent hover:ring-red-300">
                      {website.image ? (
                        <div
