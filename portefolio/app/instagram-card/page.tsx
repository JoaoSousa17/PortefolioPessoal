      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <div className="pt-20 pb-8 px-8">
            ...
            {/* Headline */}
            {headline && (
              <p className="text-slate-700 text-center leading-relaxed mb-8 text-sm font-medium animate-in fade-in slide-in-from-bottom duration-700 whitespace-pre-line"
