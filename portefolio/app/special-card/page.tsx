  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Wrapper relativo para o botão ? não ser cortado pelo overflow-hidden do card */}
...
<Button
  asChild
  variant="ghost"
  className="absolute top-4 right-4 z-20 w-8 h-8 p-0 rounded-full border border-red-100 bg-[#FFF5F5] shadow-sm hover:bg-[#FFEAEA] transition-colors duration-200 group"
>
  <a href="/special-page" className="flex items-center justify-center">
    <span className="text-sm font-medium text-red-300 group-hover:text-red-500 transition-colors">
      ?
    </span>
  </a>
</Button>
