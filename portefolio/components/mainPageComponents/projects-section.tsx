    ...
    <section className="relative w-full bg-[#A99290] py-16 md:py-24 overflow-hidden">
      ...
      <div className="relative container mx-auto px-6">
        ...
        <div className="flex justify-center animate-in fade-in slide-in-from-bottom">
          <Button
            size="lg"
            className="bg-white hover:bg-gray-50 text-slate-900 text-xl font-bold px-12 py-7 shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300 group border-4 border-white hover:scale-105"
            asChild
          >
            <Link href="/projects">
              {t.projects.viewAll}
