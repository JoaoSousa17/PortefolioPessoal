...
export function SkillBadge({
  ...
  return (
    <div className="relative" onMouseEnter={() => ctx && setShow(true)} onMouseLeave={() => setShow(false)}>
      <Badge
        ...
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 z-50 pointer-events-none"
          ...
          <div className="relative rounded-xl shadow-2xl overflow-hidden border"
            ...
            <div className="absolute inset-0 pointer-events-none"
              style={{ background: isLight ? 'linear-gradient(135deg,rgba(255,255,255,0.28) 0%,transparent 55%)' : 'linear-gradient(135deg,rgba(255,255,255,0.10) 0%,transparent 55%)' }} />
          ...
          <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-3 h-3 rotate-45"
            style={{ backgroundColor: bg, boxShadow: isLight ? '1px 1px 2px rgba(0,0,0,0.08)' : '1px 1px 2px rgba(0,0,0,0.2)' }} />
        </div>
      )}
    ...
    <div className="space-y-12">
      {categories
        ...
        .map((category, categoryIndex) => {
          ...
          return (
            <div key={category.id} className="animate-in fade-in slide-in-from-bottom"
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => {
                  ...
                  return (
                    <SkillBadge key={skill.id} skill={skill} skillName={skillName}
                      ctx={hasCtx ? ctx : null}
...
export function SkillsSectionDesktop() {
  ...
  return (
    <section className="relative w-full bg-[#E8E2E1] overflow-hidden" style={{ paddingBottom: '5rem' }}>
      ...
      {/* Extra top padding so content sits below nav — Spline will bleed upward */}
      ...
      <div className="relative container mx-auto px-6">
        ...
        {/* ── Main layout: left content column + right Spline (overflows upward) ── */}
        <div className="flex items-start gap-8">

          {/* ── Left column ── */}
          <div className="flex flex-col gap-6 w-[300px] flex-shrink-0 pt-4">

            {/* Section header — moved into left column */}
          ...
          {/* ── Right: Spline bleeds upward out of section ── */}
          <div
            ref={splineWrapRef}
            className="flex-1 spline-wrap"
            style={{
              height: '680px',
              marginTop: '-5rem',   /* bleed up over the section top padding */
            }}
          >
